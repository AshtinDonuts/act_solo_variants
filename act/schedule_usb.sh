...
python3 imitate_episodes_record_torque.py \
--task_name usb_plug \
--ckpt_dir ./ckpt_dir/usb_plug_obs_target \
--robot /home/khw/interbotix_ws/src/aloha/config/robot/aloha_solo \
--policy_class ACT \
--kl_weight 10 \
--chunk_size 100 \
...
python3 imitate_episodes_record_torque.py \
--task_name usb_plug \
--ckpt_dir ./ckpt_dir/usb_plug_2view \
--robot /home/khw/interbotix_ws/src/aloha/config/robot/aloha_solo \
--policy_class ACT \
--kl_weight 10 \
--chunk_size 100 \
...
python3 imitate_episodes_record_torque.py \
--task_name usb_plug \
--ckpt_dir ./ckpt_dir/usb_plug_2view_obs_target \
--robot /home/khw/interbotix_ws/src/aloha/config/robot/aloha_solo \
--policy_class ACT \
--kl_weight 10 \
--chunk_size 100 \
...
--exclude_cameras camera_left_shoulder \
--lr 2e-5 --seed 0 --use_obs_target \
> usb_plug_2view_obs_target.log 2>&1
...
python3 imitate_episodes_record_torque.py \
--task_name usb_plug \
--ckpt_dir ./ckpt_dir/usb_plug_1view \
--robot /home/khw/interbotix_ws/src/aloha/config/robot/aloha_solo \
--policy_class ACT \
--kl_weight 10 \
--chunk_size 100 \
...
python3 imitate_episodes_record_torque.py \
--task_name usb_plug \
--ckpt_dir ./ckpt_dir/usb_plug_1view_obs_target \
--robot /home/khw/interbotix_ws/src/aloha/config/robot/aloha_solo \
--policy_class ACT \
--kl_weight 10 \
--chunk_size 100 \
...
--exclude_cameras camera_right_shoulder camera_left_shoulder \
--lr 2e-5 --seed 0 --use_obs_target \
> usb_plug_1view_obs_target.log 2>&1
