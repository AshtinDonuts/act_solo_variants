...
def get_args_parser():
    """Standard Args parser inherited from ACT codebase"""
    ...
    parser.add_argument('--ablation_mode', default='full', type=str,
                        ...
                        help="Ablation mode: seg_only, seg_obj, seg_obj_eef, or full")
    parser.add_argument('--pose_noise_scale', default=0.0, type=float,
                        help="Scale for random noise on pose overlays (for augmentation)")
    parser.add_argument('--axis_length', default=0.05, type=float,
...
def build_SegACT_model_and_optimizer(args_override):
    parser = argparse.ArgumentParser('SegACT training and evaluation script', parents=[get_args_parser()])
