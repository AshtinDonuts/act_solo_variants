...
### Training
```
python3 imitate_episodes_rec_torque.py   --task_name plug_insert   --ckpt_dir ./ckpt_dir/plug_insert_obs_target   --robot /home/khw/interbotix_ws/src/aloha/config/robot/aloha_solo   --policy_class ACT   --kl_weight 10   --chunk_size 100   --hidden_dim 512   --batch_size 8   --dim_feedforward 3200   --num_epochs 6000   --lr 1e-5 --seed 0 --use_obs_target
```
