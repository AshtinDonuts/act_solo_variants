...
import numpy as np
import torch
from .models import build_IACT_B_model
...
def build_IACT_B_model_and_optimizer(args_override):
    parser = argparse.ArgumentParser('IACT_B training and evaluation script', parents=[get_args_parser()])
    args = parser.parse_args()

    for k, v in args_override.items():
        setattr(args, k, v)

    model = build_IACT_B_model(args)
    model.cuda()
