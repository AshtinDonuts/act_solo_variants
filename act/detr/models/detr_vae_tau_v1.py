...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, state_dim, num_queries, camera_names):
        ...
        self.encoder_action_proj = nn.Linear(7, hidden_dim)  # project to embedding dim
        self.encoder_joint_proj = nn.Linear(7, hidden_dim)
        self.encoder_effort_proj = nn.Linear(7,hidden_dim)
    ...
    def forward(self, qpos, image, effort, env_state, actions=None, is_pad=None):
        ...
        if is_training:
            ...
            effort_embed = self.encoder_joint_proj(effort)          # (bs, hidden_dim)
